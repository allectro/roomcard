...
Верстка компонента карточек номеров для букинга. Задача интересная, необходимо было сверстать карточку в двух представлениях - горизонтально и вертикально 
...
<br>
В ходе разработки получил знания и и навыки:
- основы Angular
- препроцессор SASS
____
